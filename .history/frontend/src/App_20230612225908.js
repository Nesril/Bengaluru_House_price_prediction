...
function App() {
  ...
  useEffect(()=>{ 
      ...
      localStorage.setItem("user_prediction",JSON.stringify(userData))
  ...
  return (
    <div >
     <BrowserRouter>
        <Routes>
             <Route path='/' element={<Main count={count} setCount={setCount} userData={userData} setUserData={setUserData}/>}>
