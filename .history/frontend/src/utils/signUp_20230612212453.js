...
let minimalWidth=useMediaQuery('(max-width:500px)')
  return (
    <div className={`signUp ${minimalWidth&&"minimumSignUpMessage"}`}>
      <div className='signUp-leftChild'>
         <div className='signUp-leftChild-imageText'>
              <div><img src='/alif-devs-logo_20230519_212941430.png' width={450}/></div>
              <div>Alif Developers</div>
         </div>
      </div>
